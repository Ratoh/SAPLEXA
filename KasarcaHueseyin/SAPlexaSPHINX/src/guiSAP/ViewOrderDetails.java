...
public class ViewOrderDetails {
	...
	public void createTable() {
		...
		for (int i = 0; i < items.length; i++) {
			...
			text.setFont(new Font(display, "Calibri", 19, SWT.NONE));
			...
			btnImage.setFont(new Font(display, "Calibri", 19, SWT.NONE));
			btnImage.addSelectionListener(new ViewImageListener(display));
			editor.grabHorizontal = true;
			editor.setEditor(btnImage, items[i], 6);
