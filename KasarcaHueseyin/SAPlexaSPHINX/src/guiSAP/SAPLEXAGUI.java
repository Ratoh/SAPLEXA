...
//	    });
	...
	public void createTable() {
		...
		String[] columns = {"Reihe", "Bestellnummer", "Lieferant", "Belegdatum"};
		...
		for (int loopIndex = 0; loopIndex < 6; loopIndex++) {
			...
			item.setText(0, "Reihe " + loopIndex);
			item.setText(1, "4500000123");
			item.setText(2, "Lieferant");
			item.setText(3, "Datum");
			
			item.setFont(new Font(display, "Calibri", 22, SWT.NONE));
