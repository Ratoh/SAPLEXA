...
public class ButtonSeeDetailsListener extends SelectionAdapter {
	...
	//Image uncheckedImage = new Image(display, "C:/Users/hkasa/Desktop/ov_schrauben.jpg");
	...
	public void createTable() {
		...
		String[] columns = { "Position", "Material", "Kurzbezeichnung", "offene Menge", "angelieferte Menge", "Lagerort", "Bild"};
		...
		for (int loopIndex = 0; loopIndex < 3; loopIndex++) {
			...
			//item.setImage(6, uncheckedImage);
			item.setText(6, "");
