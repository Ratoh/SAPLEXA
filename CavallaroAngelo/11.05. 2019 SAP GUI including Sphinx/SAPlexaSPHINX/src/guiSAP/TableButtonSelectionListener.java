...
public class TableButtonSelectionListener extends SelectionAdapter {
	...
	public void createTable() {
		...
		String[] columns = { "Position", "Kurzbezeichnung", "Menge", "Lager" };
		...
		for (int loopIndex = 0; loopIndex < 6; loopIndex++) {
			...
			item.setText(2, "4");
			item.setText(3, "Fertigwaren-Lager");
	...
	public void createButtons() {
		...
		showSelectedRows.setText("Buchen");
		...
		backDeliveryButton.setText("Zurücksenden");
